...
class TimeSeriesDataset(AbstractBaseTimeSeries,
    ...
    def select_components_by_percentage(self, percent: float, seed: int = None, indices: bool = False) -> Any:
        """
        ...
        if indices:
            return self.select_components_randomly(n=n, seed=seed, indices=indices)
        else:
            return self.select_components_randomly(n=n, seed=seed)
