...
from timeatlas import TimeSeries, TimeSeriesMetadata
...
class TestTimeSeries(TestCase):
    ...
    def test__TimeSeries__has_right_types(self):
        ...
        my_metadata = TimeSeriesMetadata()
        ...
        self.assertIsInstance(my_ts.metadata, TimeSeriesMetadata,
    ...
    def test__TimeSeries__import_csv(self):
        self.fail()

    def test__TimeSeries__export_csv(self):
        self.fail()
